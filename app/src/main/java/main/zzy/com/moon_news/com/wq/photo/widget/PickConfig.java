package main.zzy.com.moon_news.com.wq.photo.widget;
...
public class PickConfig {
    ...
    public final static String EXTRA_IS_ROUND_CROP="extra_isround_crop";
    ...
    private PickConfig(Activity context, PickConfig.Builder builder) {
        ...
        bundle.putBoolean(EXTRA_IS_ROUND_CROP,this.isRoundCrop);
    ...
    public static class Builder {
        ...
        private boolean isRoundCrop =false;
        ...
        public PickConfig.Builder isRoundCrop(boolean isRoundCrop){
